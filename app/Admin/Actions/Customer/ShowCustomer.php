...
class ShowCustomer extends RowAction
{
    ...
    public function dialog()
    {
        if (Admin::user()->isRole('Sm') || Admin::user()->isRole('administrator') ) {
            $this->confirm('Bạn muốn xác nhận show này?');
        }
    }
    ...
    public function handle(Appointment $appointment)
    {
        ...
        $html = $appointment->show == 1 ? "<i class=\"fa fa-check text-warning\"></i>" : "<i class=\"fa fa-times\"></i>";
