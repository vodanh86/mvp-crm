...
class FormalityOpsController extends AdminController
{
    /**
    ...
    {
        $grid = new Grid(new FormalityOps());
    ...
    {
        $show = new Show(FormalityOps::findOrFail($id));
    ...
    {
        $form = new Form(new FormalityOps());
